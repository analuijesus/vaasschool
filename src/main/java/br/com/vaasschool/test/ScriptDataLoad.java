    ...
    public static void main(String[] args) throws Exception {
        ...
        try (OutputStream os = new FileOutputStream("vaasschool_dados.sql")) {
            ...
            for (Category category : categories) {
                ...
                ps.println(String.format(sqlCategory, name, code, order, description, active, imagePath, colorCode));
            }
            ...
            for (Subcategory subcategory : subcategories) {
                ...
                ps.println(String.format(sqlSubcategory, name, code, order, description, active, category.getCode()));
            }
            ...
            for (Course course : courses) {
                ...
                ps.println(String.format(sqlCourse, name, code, estimatedTimeToFinish, visibility, targetAudience,
